...
/*
	Таблицы взяты с https://ru.wikipedia.org/wiki/DES
*/
const encryptBlockSize = 8

// Table 1
var startPermutationPositions = []byte{
...
// Table 2
var extenssionTablePositionsE = []byte{
	32, 1, 2, 3, 4, 5,
	4, 5, 6, 7, 8, 9,
	8, 9, 10, 11, 12, 13,
	12, 13, 14, 15, 16, 17,
...
// Table 4
var permutationFestelPositions = []byte{
...
// Table 5 Part 1
var extendKeyPositionsC = [...]byte{
	57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18,
	10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60, 52, 44, 36,
}

// Table 5 Part 2
var extendKeyPositionsD = [...]byte{
	63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22,
	14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 28, 20, 12, 4,
}

// Table 6
var encryptShiftingPositions = []byte{
	1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1,
}

// Table 7
var finalKeyRoundPermutationPosisitions = []byte{
...
// Table 8
var lastPermutationPositions = []byte{
...
// Table 9
var decryptShiftingPositions = []byte{
